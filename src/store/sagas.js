...
function* api_v1_address_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_address_list, action)
    yield put(actions.api_v1_address_listSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_address_listFailed(err))
  }
}
function* api_v1_address_listWatcher() {
  yield takeEvery(types.API_V1_ADDRESS_LIST, api_v1_address_listWorker)
}
function* api_v1_address_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_address_create, action)
    yield put(actions.api_v1_address_createSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_address_createFailed(err))
  }
}
function* api_v1_address_createWatcher() {
  yield takeEvery(types.API_V1_ADDRESS_CREATE, api_v1_address_createWorker)
}
function* api_v1_address_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_address_read, action)
    yield put(actions.api_v1_address_readSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_address_readFailed(err))
  }
}
function* api_v1_address_readWatcher() {
  yield takeEvery(types.API_V1_ADDRESS_READ, api_v1_address_readWorker)
}
function* api_v1_address_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_address_update, action)
    yield put(actions.api_v1_address_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_address_updateFailed(err))
  }
}
function* api_v1_address_updateWatcher() {
  yield takeEvery(types.API_V1_ADDRESS_UPDATE, api_v1_address_updateWorker)
}
function* api_v1_address_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_address_partial_update, action)
    yield put(actions.api_v1_address_partial_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_address_partial_updateFailed(err))
  }
}
function* api_v1_address_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_ADDRESS_PARTIAL_UPDATE,
    api_v1_address_partial_updateWorker
  )
}
function* api_v1_address_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_address_delete, action)
    yield put(actions.api_v1_address_deleteSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_address_deleteFailed(err))
  }
}
function* api_v1_address_deleteWatcher() {
  yield takeEvery(types.API_V1_ADDRESS_DELETE, api_v1_address_deleteWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    api_v1_address_listWatcher,
    api_v1_address_createWatcher,
    api_v1_address_readWatcher,
    api_v1_address_updateWatcher,
    api_v1_address_partial_updateWatcher,
    api_v1_address_deleteWatcher,
