...
export const api_v1_address_list = () => ({ type: types.API_V1_ADDRESS_LIST })
export const api_v1_address_listSucceeded = response => ({
  type: types.API_V1_ADDRESS_LIST_SUCCEEDED,
  response
})
export const api_v1_address_listFailed = error => ({
  type: types.API_V1_ADDRESS_LIST_FAILED,
  error
})
export const api_v1_address_create = () => ({
  type: types.API_V1_ADDRESS_CREATE
})
export const api_v1_address_createSucceeded = response => ({
  type: types.API_V1_ADDRESS_CREATE_SUCCEEDED,
  response
})
export const api_v1_address_createFailed = error => ({
  type: types.API_V1_ADDRESS_CREATE_FAILED,
  error
})
export const api_v1_address_read = () => ({ type: types.API_V1_ADDRESS_READ })
export const api_v1_address_readSucceeded = response => ({
  type: types.API_V1_ADDRESS_READ_SUCCEEDED,
  response
})
export const api_v1_address_readFailed = error => ({
  type: types.API_V1_ADDRESS_READ_FAILED,
  error
})
export const api_v1_address_update = () => ({
  type: types.API_V1_ADDRESS_UPDATE
})
export const api_v1_address_updateSucceeded = response => ({
  type: types.API_V1_ADDRESS_UPDATE_SUCCEEDED,
  response
})
export const api_v1_address_updateFailed = error => ({
  type: types.API_V1_ADDRESS_UPDATE_FAILED,
  error
})
export const api_v1_address_partial_update = () => ({
  type: types.API_V1_ADDRESS_PARTIAL_UPDATE
})
export const api_v1_address_partial_updateSucceeded = response => ({
  type: types.API_V1_ADDRESS_PARTIAL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_address_partial_updateFailed = error => ({
  type: types.API_V1_ADDRESS_PARTIAL_UPDATE_FAILED,
  error
})
export const api_v1_address_delete = () => ({
  type: types.API_V1_ADDRESS_DELETE
})
export const api_v1_address_deleteSucceeded = response => ({
  type: types.API_V1_ADDRESS_DELETE_SUCCEEDED,
  response
})
export const api_v1_address_deleteFailed = error => ({
  type: types.API_V1_ADDRESS_DELETE_FAILED,
  error
})
