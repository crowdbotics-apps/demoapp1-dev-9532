...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.API_V1_ADDRESS_LIST:
    case types.API_V1_ADDRESS_LIST_SUCCEEDED:
    case types.API_V1_ADDRESS_LIST_FAILED:
    case types.API_V1_ADDRESS_CREATE:
    case types.API_V1_ADDRESS_CREATE_SUCCEEDED:
    case types.API_V1_ADDRESS_CREATE_FAILED:
    case types.API_V1_ADDRESS_READ:
    case types.API_V1_ADDRESS_READ_SUCCEEDED:
    case types.API_V1_ADDRESS_READ_FAILED:
    case types.API_V1_ADDRESS_UPDATE:
    case types.API_V1_ADDRESS_UPDATE_SUCCEEDED:
    case types.API_V1_ADDRESS_UPDATE_FAILED:
    case types.API_V1_ADDRESS_PARTIAL_UPDATE:
    case types.API_V1_ADDRESS_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_ADDRESS_PARTIAL_UPDATE_FAILED:
    case types.API_V1_ADDRESS_DELETE:
    case types.API_V1_ADDRESS_DELETE_SUCCEEDED:
    case types.API_V1_ADDRESS_DELETE_FAILED:
